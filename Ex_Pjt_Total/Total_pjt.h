 ...
 * C/C++ source code generated on : Wed Jan 22 16:45:47 2025
 *
 ...
 * '<S2>'   : 'Total_pjt/Subsystem/lightS_redLed'
 * '<S3>'   : 'Total_pjt/Subsystem/sw1_blueLed'
 * '<S4>'   : 'Total_pjt/Subsystem/lightS_redLed/red_LED_OFF'
 * '<S5>'   : 'Total_pjt/Subsystem/lightS_redLed/red_LED_ON '
 * '<S6>'   : 'Total_pjt/Subsystem/sw1_blueLed/sw_off'
 * '<S7>'   : 'Total_pjt/Subsystem/sw1_blueLed/sw_on '
 */
